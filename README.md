...
```gradle
dependencies {
    compile 'com.github.VictorAlbertos.RxSocialConnect-Android:core:0.1.7'
...
```gradle
dependencies {
    compile 'com.github.VictorAlbertos.RxSocialConnect-Android:okhttp_interceptors:0.1.7'
}
``` 
